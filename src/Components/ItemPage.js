...
function ItemPage(props) {
  ...
  const submitActivate=()=>{
    ...
    Axios({
      method:"POST",
      url:`http://localhost:5000/login/activateItem/${item_id}`
  ...
  useEffect(() => {
    ...
    Axios({
      //url: `http://localhost:5000/login/item/
  ...
  const submitResponse = () => {
    ...
    Axios({
      //url: `http://localhost:5000/login/confirmResponse/
  ...
  const delete_item = () => {
    console.log("deleted");
    Axios({
      //url: "http://localhost:5000/login/deleteitem",
  ...
  const handleEdit = () => {
    ...
    Axios({
      //url: "http://localhost:5000/login/edititem",
  ...
  const submitAnswer = () => {
    Axios({
      ...
      //url: "http://localhost:5000/login/submitAnswer",
      method: "POST",
      data: {
        itemId: item_id,
